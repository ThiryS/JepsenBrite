    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('admin.event.update', $event->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ $event->date }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="form-control-file" type="file" name="image" class="@error('image') is-invalid @enderror" value="{{ $event->image }}">
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('admin.event.show', $event->id) }}">Retour</a>
                            </div>
                        </div>
                    </form>
                </div>
